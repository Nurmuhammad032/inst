...
import { updateAvatarUser } from "../../Allservices/firebase";
import ReactLoading from "react-loading";
import useUser from "../../CustomHooks/useUser";
import { updateUser } from "../../Allservices/firebase";
      ...
      <div className="border-2xl flex mt-0 border-[1px] bg-white  flex-col p-4 rounded">
        <div className="flex items-center mt-4 mb-4 justify-end">
          ...
          <div className="mb-2 flex-auto w-60 ml-4">
            ...
            >
              <span className="bg-blue-500 rounded p-2 text-white">
                Upload image
              </span>
              <input
                ref={imageRef}
        ...
        <div className="flex ">
          ...
          <div className="flex-auto w-full">
            <input
              ...
              className="h-10 border bg-[#fafafa] p-2 rounded w-full "
              type="text"
              id="fullname"
            />
          </div>
        ...
        <div className="flex mt-6">
          ...
          <div className="flex-auto w-60 ...">
            {!loading ? (
              <button
                className="bg-blue-500 font-semibold text-sm rounded text-white w-20 h-8"
